...
const ProductCart = ({id, title, description, price, thumbnail, category}) => {
  return (
    <>   
        <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm" id={id}>
            <a href="#">
            ...
            <div class="px-5 pb-5 flex flex-col">
                ...
                <div className='flex-fill'>
                    <h5 class="text-sm font-semibold tracking-tight text-gray-900">{category}</h5>
                    ...
                    <div className='mt-6'>
                        <a href="#" class="text-white bg-blue-700 block hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full">Add to cart</a>
                    </div>
                </div>
            </div>
        </div>
